...
/** MySQL settings **/
define('DB_NAME', 'vangoidt_site'); //The name of your database. Note that this database must exist before running installer.php
define('DB_USER', 'vangoidt_db'); //Your database username
define('DB_PASSWORD', 'dmAXR4v'); //Your database users password
define('DB_HOST', 'localhost'); //The hostname for your database

/** Admin user and password **/
define('ADMIN_USER','willy');
define('ADMIN_PASSWORD','willy7856');
...
define('RECAPTCHA_PUBLIC_KEY','6LfYAQUAAAAAAH2cPLfqBSi7QdwsGTSL3rvhyK1y');
define('RECAPTCHA_PRIVATE_KEY','6LfYAQUAAAAAAD1G_qf-VCmhQu3t5AVYbgYiqiJJ');
