...
/** MySQL settings **/
define('DB_NAME', 'janss_svg'); //The name of your database. Note that this database must exist before running installer.php
define('DB_USER', 'tom'); //Your database username
define('DB_PASSWORD', 'tom'); //Your database users password
define('DB_HOST', 'xserve.dyndns.info'); //The hostname for your database
...
define('RECAPTCHA_PUBLIC_KEY','6LeiAQUAAAAAAJ6j7va8CQxeh-IZi8UZLJ4P1FH5 ');
define('RECAPTCHA_PRIVATE_KEY','6LeiAQUAAAAAAMzIDbyq04ixJwE2q5FMMflKZvu3');
